...
// // **IMPORTANT**: Remove the module.exports from the bottom of this file.
// // We are no longer exporting anything.
...
app.use(cors({
    origin: "http://localhost:3000",
    credentials: true,
    // Add the following two lines to allow the Authorization header
